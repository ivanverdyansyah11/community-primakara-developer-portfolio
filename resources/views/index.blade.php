...
@section('content-page')
    ...
    <section class="portfolio section-gap" id="portfolio">
        <div class="row justify-content-between align-items-end">
            <div class="col-lg-7 mb-3 mb-lg-0">
                <h2 data-aos="fade-up" data-aos-duration="600" class="title">Primakara Developer Community Project Portfolio</h2>
            </div>
            <div class="col-lg-4">
                <p data-aos="fade-up" data-aos-duration="600" data-aos-delay="150" class="paragraph-small">Dive into the diverse world of creativity and innovation within the Primakara Developer Community.</p>
            </div>
        </div>
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 content-gap">
            <div class="col">
                <button data-aos="fade-up" data-aos-duration="600" type="button" class="card-default" data-bs-toggle="modal" data-bs-target="#portfolioOneModal">
            ...
            <div class="col mt-4 mt-md-0">
                <button data-aos="fade-up" data-aos-duration="600" data-aos-delay="150" type="button" class="card-default" data-bs-toggle="modal" data-bs-target="#portfolioTwoModal">
            ...
            <div class="col mt-4 mt-lg-0">
                <button data-aos="fade-up" data-aos-duration="600" data-aos-delay="300" type="button" class="card-default" data-bs-toggle="modal" data-bs-target="#portfolioThreeModal">
            ...
            <div class="col mt-4 mt-xl-0">
                <button data-aos="fade-up" data-aos-duration="600" data-aos-delay="450" type="button" class="card-default" data-bs-toggle="modal" data-bs-target="#portfolioFourModal">
        ...
        <div class="row content-gap">
            <div data-aos="fade-up" data-aos-duration="600" class="col-12 d-flex justify-content-center">
