    ...
    <section class="hero hero-portfolio portfolio text-lg-center" id="hero">
        <div class="row justify-content-lg-center">
            <div class="col-xxl-10 d-flex flex-column align-items-lg-center">
                <h1 class="headline">Explore a Tapestry of Diverse Portfolio Projects within Primakara Developer Community</h1>
                <form class="w-100">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 content-gap">
            ...
            <div class="col mt-4">
                <button type="button" class="card-default" data-bs-toggle="modal" data-bs-target="#portfolioNineModal">
            ...
            <div class="col mt-4">
                <button type="button" class="card-default" data-bs-toggle="modal" data-bs-target="#portfolioTenModal">
